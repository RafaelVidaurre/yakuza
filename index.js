...
function Yakuza () {
  ...
  _this._createScraper = function (scraperName) {
    _this._scrapers[scraperName] = new Scraper();
    return _this._scrapers[scraperName];
  };
  ...
  _this.scraper = function (scraperName) {
    ...
    scraperExists = utils.hasKey(_this._scrapers, scraperName);
    thisScraper = scraperExists ? _this._scrapers[scraperName] : _this._createScraper(scraperName);
